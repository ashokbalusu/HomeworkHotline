...
namespace ExelConvertDemo
{
	...
	class Program
    {
        ...
        {           
            ...
            tm.FirstColumn = 1;
            tm.SecondColumn = "A1";
            tm.ThirdColumn = "First Column Value";
            tm.SampleDate = DateTime.Now.Date;
            tmList.testData.Add(tm);

            TestModel tm1 = new TestModel();
            tm1.FirstColumn = 2;
            tm1.SecondColumn = "A2";
            tm1.ThirdColumn = "Second Column Value";
            tm1.SampleDate = DateTime.Now.AddDays(-1);
            tmList.testData.Add(tm1);

            TestModel tm2 = new TestModel();
            tm2.FirstColumn = 3;
            tm2.SecondColumn = "A3";
            tm2.ThirdColumn = "3rd Column Value";
            tm2.SampleDate = DateTime.Now.AddDays(-2);
            tmList.testData.Add(tm2);

            TestModel tm3 = new TestModel();
            tm3.FirstColumn = 4;
            tm3.SecondColumn = "A4";
            tm3.ThirdColumn = "4th Column Value";
            tm3.SampleDate = DateTime.Now.AddDays(-3);
            tmList.testData.Add(tm3);

            Program p = new Program();
     // change the output location
            p.CreateExcelFile(tmList, "c:\\");
        }
        ...
        {
            Row tRow = new Row();
            tRow.Append(CreateCell(testmodel.FirstColumn.ToString()));
            tRow.Append(CreateCell(testmodel.SecondColumn));
            tRow.Append(CreateCell(testmodel.ThirdColumn));
            tRow.Append(CreateCell(testmodel.SampleDate.ToShortDateString()));
            return tRow;
        }
